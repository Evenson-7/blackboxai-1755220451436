...
import { Clock, FileText, Calendar, BarChart2, Menu, ChevronLeft, User, Layout } from 'lucide-react';
...
const InternLayout = () => {
  ...
  const navItems = [
    { icon: Layout, label: 'Dashboard', path: 'dashboard1' },
    { icon: Clock, label: 'My Timesheet', path: 'my-timesheet' },
